          ...
          <div class="col-lg-8">
              ...
              <div class="card-body px-4 py-3">
                ...
                >
                  <div class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <span
                      class="badge border border-danger text-danger fw-normal"
                    >
                      Default
                    </span>
                  </div>
              ...
              <div class="card-body px-4 py-3">
                ...
                <div class="d-flex align-items-start gap-3">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="text-muted small mt-1">x1</div>
                  </div>

                  <!-- Price -->
                  <div class="text-end">
                    <div class="fw-semibold text-danger">₱1,299</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body px-4 py-3">
                ...
                <!-- Option -->
                <label
                  class="delivery-option d-flex justify-content-between align-items-start mb-2"
                >
                ...
                <!-- Option -->
                <label
                  class="delivery-option d-flex justify-content-between align-items-start"
                >
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body px-4 py-3">
                ...
                <!-- Option -->
                <label
                  class="payment-option d-flex justify-content-between align-items-center mb-2"
                >
          ...
          <div class="col-lg-4">
            <div class="card border-0 shadow-sm sticky-top" style="top: 90px">
              <div class="card-body">
                ...
                <div class="card border-0 shadow-sm mb-4">
                  <div
                    class="card-body px-4 py-3 d-flex justify-content-between align-items-center"
                  >
